...
class TestBurnKeyCommands(EfuseTestCase):
    ...
    @pytest.mark.skipif(
        Command(arg_chip, "burn_key").does_not_support("BLOCK_KEY5"),
    ...
    def test_burn_key_with_6_keys(self):
        ...
        if Command(arg_chip, "burn_key").does_not_support("XTS_AES_256_KEY"):
    ...
    @pytest.mark.skipif(
        Command(arg_chip, "burn_key").does_not_support("XTS_AES_256_KEY"),
    ...
    @pytest.mark.skipif(
        Command(arg_chip, "burn_key").does_not_support("XTS_AES_256_PSRAM_KEY"),
        reason="512 bit keys not supported on this chip",
    )
    ...
    @pytest.mark.skipif(
        Command(arg_chip, "burn_key").does_not_support("ECDSA_KEY"),
...
class TestMultipleCommands(EfuseTestCase):
    ...
    @pytest.mark.skipif(
        Command(arg_chip, "burn_key").does_not_support(
            "XTS_AES_128_KEY_DERIVED_FROM_128_EFUSE_BITS"
        ),
