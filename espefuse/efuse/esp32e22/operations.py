# This file includes the operations with eFuses for ESP32-E22 chip
#
...
class ESP32E22Commands(BaseCommands):
    CHIP_NAME = "ESP32-E22"
    ...
    def add_cli_commands(self, cli: click.Group):
        ...
        @cli.command(
            "set-flash-voltage",
            short_help="Set internal flash voltage regulator.",
    ...
    def set_flash_voltage(self, voltage: str):
        """Set the Flash Voltage. Not supported for ESP32-E22."""
