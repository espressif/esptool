...
class ESP32C6Commands(BaseCommands):
    ...
    def adc_info(self):
        ...
        if self.efuses.get_block_version() >= 1:
            ...
            log.print("INIT_CODE_ATTEN0_CH0 = ", self.efuses['ADC1_INIT_CODE_ATTEN0_CH0'].get())
            log.print("INIT_CODE_ATTEN0_CH1 = ", self.efuses['ADC1_INIT_CODE_ATTEN0_CH1'].get())
            log.print("INIT_CODE_ATTEN0_CH2 = ", self.efuses['ADC1_INIT_CODE_ATTEN0_CH2'].get())
            log.print("INIT_CODE_ATTEN0_CH3 = ", self.efuses['ADC1_INIT_CODE_ATTEN0_CH3'].get())
            log.print("INIT_CODE_ATTEN0_CH4 = ", self.efuses['ADC1_INIT_CODE_ATTEN0_CH4'].get())
            log.print("INIT_CODE_ATTEN0_CH5 = ", self.efuses['ADC1_INIT_CODE_ATTEN0_CH5'].get())
            log.print("INIT_CODE_ATTEN0_CH6 = ", self.efuses['ADC1_INIT_CODE_ATTEN0_CH6'].get())
            # fmt: on
