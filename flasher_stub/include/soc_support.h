...
#ifdef ESP32C5
#define WITH_USB_JTAG_SERIAL 0 // not implemented yet
#define IS_RISCV 1
#endif // ESP32C5
...
#define USE_MAX_CPU_FREQ ((WITH_USB_JTAG_SERIAL || WITH_USB_OTG) && !ESP32S3 && !ESP32P4)
...
#if ESP32P4
#define UART_USB_OTG  5
#define UART_USB_JTAG_SERIAL  6
